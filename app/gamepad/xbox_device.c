...
//uint8c_t xbox_version[] = {0x05, 0x00, 0x0D, 0x00, 0x47, 0x0C, 0x00, 0x00};		//firmware version 5.5.2641.0 xboxx
//uint8c_t xbox_info_unknow[] = {0x08,0x04,0x01,0x00,0x01,0x00,0x01,0x00};
uint8c_t xbox_version[] = {0x04, 0x00, 0x08, 0x00, 0x83, 0x07, 0x00, 0x00};		//firmware version 5.5.2641.0 xboxone
uint8c_t xbox_info_unknow[] = {0x04,0x05,0x01,0x00,0x01,0x00,0x01,0x00};
