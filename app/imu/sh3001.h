...
#define SH3001_ID				    (0x61)  
#define SH3011_ID				    (0x62)  
...
*       Type Definitions                                              
****************************************************************************/
typedef bool (*IMU_read)(	unsigned char devAddr, 
                                    unsigned char regAddr, 
                                    unsigned char readLen, 
                                    unsigned char *readBuf);

typedef bool (*IMU_write)(	unsigned char devAddr, 
                                    unsigned char regAddr, 
...
/***************************************************************************
        Exported Functions                                           
****************************************************************************/																															
extern int16_t sh3001_imu_data[];		

extern unsigned char SH3001_init(acc_range_t acc_range, gyro_range_t gyro_range);
uint8_t SH3001_read_id(void);
extern bool SH3001_GetImuData( short accData[3], short gyroData[3] );
extern bool SH3001_GetImuCompData(short accData[3], short gyroData[3],unsigned char isr);
